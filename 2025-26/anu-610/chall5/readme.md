...
14. here is first shows the same big meta description, after that i got something like openPGP key ... then said this to gemini and it said it is a lead and to extarct that key it gave a command zsteg -E b8,b,lsb,xy final.png > secret.key

15. Then i inspected this keys (gpg --import secret.key, gpg --list-keys) but didnt worked.
